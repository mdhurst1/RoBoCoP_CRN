...
int main()
{
	...
	double BeachWidth = 100.;             //Beach width landward of berm
  ...
  string OutFileName = "BeachWidth_Bh1_Bw0";
  ...
  cout << "\tBeach Width is 10 m" << endl;
	BeachWidth = 10;
	OutFileName = "BeachWidth_Bh1_Bw10";
	...
	BeachWidth = 20;
	OutFileName = "BeachWidth_Bh1_Bw20";
	...
	BeachWidth = 50;
	OutFileName = "BeachWidth_Bh1_Bw50";
	RockyCoastCRN RockyCoastCRNModel4(RetreatRate1, RetreatRate2, RetreatType, ChangeTime, BeachWidth, BermHeight, PlatformGradient, CliffHeight, JunctionElevation, Amp, SteppedPlatformFlag, StepSize);
	RockyCoastCRNModel4.RunModel(OutFileName);
	
	//Create Platform CRN object
	cout << "\tBeach Width is 100 m" << endl;
	BeachWidth = 100;
	OutFileName = "BeachWidth_Bh1_Bw100";
	RockyCoastCRN RockyCoastCRNModel5(RetreatRate1, RetreatRate2, RetreatType, ChangeTime, BeachWidth, BermHeight, PlatformGradient, CliffHeight, JunctionElevation, Amp, SteppedPlatformFlag, StepSize);
