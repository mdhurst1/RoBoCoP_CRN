...
int main()
{
	...
	int BeachType = 2;                    //0 = constant beach width, 1 = sinusoidal beach width, 2 = thinning beach
	...
	//Run the model
  //First for no beach
  cout << "\tBeach Width is 100 m thinning" << endl;
  string OutFileName = "Thinning_Bh1_Bw100.pdat";
	...
	//Run the model
  //First for no beach
  cout << "\tBeach Width is 200 m thinning" << endl;
  OutFileName = "Thinning_Bh1_Bw200.pdat";
	...
	//Run the model
  //First for no beach
  cout << "\tBeach Width is 50 m thinning" << endl;
  OutFileName = "Thinning_Bh1_Bw50.pdat";
